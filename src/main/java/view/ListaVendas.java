...
public class ListaVendas extends javax.swing.JFrame {
    ...
    public void loadVendas() {
        ...
        modelo.setNumRows(0);
        for (Compra obj : dao.listaVendas()) {
            Object[] linha = {
                obj,
                obj.getVeiculo(),
                obj.getCliente()
    ...
    private void btnNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNovoActionPerformed
        ...
        Compra novoObj = telaVenda.getVenda();
    ...
    private void btnRemoverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoverActionPerformed
        if (tblVendas.getSelectedRow() != -1) {
            Compra obj = (Compra) tblVendas.getModel().getValueAt(tblVendas.getSelectedRow(), 0);
            String txtVenda = "Compra: { veiculo" + obj.getVeiculo().getPlaca() + ", cliente: " + obj.getCliente().getNome() + ", vendedor: " + obj.getVendedor().getNome() + "}";
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        if (tblVendas.getSelectedRow() != -1) {
            ...
            // 2. recuperar o objeto Compra
            Compra compraEdt = telaVenda.getVenda();
