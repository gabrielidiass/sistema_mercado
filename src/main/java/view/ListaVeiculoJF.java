...
public class ListaVeiculoJF extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tblVeiculos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Placa", "Marca", "Categoria", "Ano Categoria"
            }
        ) {
    ...
    private void btnNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNovoActionPerformed
        ...
        Produto novoProduto = telaCadastro.getVeiculo();
        try {
            //JOptionPane.showMessageDialog(rootPane, novoProduto);
            dao.persist(novoProduto);
        } catch (Exception ex) {
            System.out.println("Erro ao castrar o veículo "+ novoProduto.toString()+" \n Erro: "+ex);
        }
        loadTabelaVeiculos();
    ...
    private void btnInfoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInfoActionPerformed
        if(tblVeiculos.getSelectedRow() != -1){
            Produto obj_vendedor = (Produto) dao.buscarPorPlaca((String)tblVeiculos.getModel().getValueAt(tblVeiculos.getSelectedRow(), 0)).get();
    ...
    public void loadTabelaVeiculos(){
        ...
        for(Produto obj: dao.listaVeiculos()){
            Object[] linha = {
                obj.getPlaca(), 
                    obj.getMarca(), 
                    obj.getModelo(), 
