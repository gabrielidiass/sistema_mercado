...
public class ListaClienteJF extends javax.swing.JFrame {
    ...
    private void btnInfoActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnInfoActionPerformed
        if (tblFuncionarios.getSelectedRow() != -1) {
            Cliente obj = (Cliente) tblFuncionarios.getModel().getValueAt(tblFuncionarios.getSelectedRow(), 0);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListaClienteJF.class.getName()).log(java.util.logging.Level.SEVERE, null,
                    ex);
