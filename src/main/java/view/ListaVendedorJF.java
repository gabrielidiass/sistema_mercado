...
public class ListaVendedorJF extends javax.swing.JFrame {
    ...
    private void btnNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNovoActionPerformed
        ...
        Funcionario novoFuncionario = telaCadastro.getVendedor();
        if (novoFuncionario != null) {
            try {
                //JOptionPane.showMessageDialog(rootPane, novoFuncionario);
                dao.persist(novoFuncionario);
                loadTabelaVendedores();
            } catch (Exception ex) {
                System.err.println("Erro ao cadastrar Funcionario: " + ex);
            }
    ...
    private void btnInfoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInfoActionPerformed
        if (tblVendedores.getSelectedRow() != -1) {
            Funcionario obj_funcionario = (Funcionario) tblVendedores.getModel().getValueAt(tblVendedores.getSelectedRow(), 0);
            JOptionPane.showMessageDialog(rootPane, obj_funcionario.exibirDados());
        } else {
    ...
    private void btnRemoverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoverActionPerformed
        if (tblVendedores.getSelectedRow() != -1) {
            Funcionario obj_funcionario = (Funcionario) tblVendedores.getModel().getValueAt(tblVendedores.getSelectedRow(), 0);
            int op_remover = JOptionPane.showConfirmDialog(rootPane, "Tem certeza que deseja remover " + obj_funcionario + "?");
            if (op_remover == JOptionPane.YES_OPTION) {
                try {
                    dao.remover(obj_funcionario);
                } catch (Exception ex) {
                    System.err.println("Erro ao remover vendedor: " + ex);
                }
                JOptionPane.showMessageDialog(rootPane, "Funcionario removido com sucesso... ");
                loadTabelaVendedores();
            }
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        if (tblVendedores.getSelectedRow() != -1) {
            ...
            telaEdicao.setVendedor(obj_funcionario);

            telaEdicao.setVisible(true);

            Funcionario obj_retorno = telaEdicao.getVendedor();
            if (obj_retorno != null) {
                try {
                    dao.persist(obj_retorno);
                    loadTabelaVendedores();
                } catch (Exception ex) {
                    System.out.println("Erro ao editar Funcionario: " + ex);
                }
            }
    ...
    public void loadTabelaVendedores() {
        ...
        for (Funcionario funcionario : dao.listaVendedores()) {
            Object[] linha = {
                    funcionario,
                funcionario.getCPF(),
