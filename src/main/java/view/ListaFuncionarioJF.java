 ...
 */
public final class ListaFuncionarioJF extends javax.swing.JFrame {
    ...
    private void btnInfoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInfoActionPerformed
        if (tblFuncionarios.getSelectedRow() != -1) {
            Funcionario obj_funcionario = (Funcionario) tblFuncionarios.getModel().getValueAt(tblFuncionarios.getSelectedRow(), 0);
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        if (tblFuncionarios.getSelectedRow() != -1) {
            ...
            telaEdicao.setFuncionario(obj_funcionario);
    ...
    public void loadTabelaFuncionarios() {
